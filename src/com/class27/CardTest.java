...
public class CardTest {
	...
	public static void main(String[] args) {
		...
		Scanner scan;
		MC mc;
	//take an obhect of child class and give reference to the parent
		...
		//1st we created objects and assigned to the variables and then
		//stored those variables inside the array
		Card[] cardArray= {card, card1, card2};
		
		//creating an object and stpring it directly into an Array of Cards
