...
public class StringManipulations {
	...
	public static void main(String[] args) {
		//String class comes n java lang package
		...
		//find the number of characters inside of the String
		...
		//verift if there if the string is empty
		String myString=""; //we have empty value
		boolean isEmpty=myString.isEmpty();
		System.out.println(isEmpty);
		
		String myString1=null; //no value at all 
		//it is equal to String myString1
